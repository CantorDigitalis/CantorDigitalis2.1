...
A - be sure you installed the appropriate driver from wacom.


B - be sure the tablet is plugged directly to the computer and
    not throught the keyboard neither a usb hub.


C - If you got xcode installed, you can check if the bamboo touch is
...
D - Some users that had several wacom drivers installed did not have the touch
