...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.0, 239.0, 63.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 366.0, 220.0, 31.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 235.0, 175.0, 185.5, 19.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.0, 239.0, 63.0, 18.0 ],
					"text" : " fingerCount"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 301.0, 220.0, 31.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 235.0, 220.0, 31.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 235.0, 195.0, 150.0, 20.0 ],
					"text" : "unpack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 239.0, 51.0, 18.0 ],
					"text" : "deviceID"
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 545.0, 174.0, 48.0 ],
									"text" : "- Orientation is always 0\n- Confidence is always 1\n- FingerID value starts with 0"
								}
...
,
						"rect" : [ 348.0, 481.0, 518.0, 420.0 ],
						"bglocked" : 0,
						"defrect" : [ 348.0, 481.0, 518.0, 420.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 355.0, 95.0, 32.5, 20.0 ],
									"text" : "* 10."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 295.0, 95.0, 32.5, 20.0 ],
									"text" : "* 10."
								}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 30.0, 30.0, 49.079071, 14.666666 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.5,
					"id" : "obj-16",
					"items" : [ "All tablets", ",", "tablet ID 0 ", ",", "tablet ID 2 " ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 659.5, 176.0, 681.0, 176.0, 681.0, 117.0, 579.5, 117.0 ],
					"source" : [ "obj-3", 3 ]
				}
